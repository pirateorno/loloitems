...
public class KillersFlagBlock extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:killers_flag")
	public static final Block block = null;

	public KillersFlagBlock(LoloitemsModElements instance) {
		super(instance, 165);
	}
