...
public class VoriflagBlock extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:voriflag")
	public static final Block block = null;

	public VoriflagBlock(LoloitemsModElements instance) {
		super(instance, 162);
	}
