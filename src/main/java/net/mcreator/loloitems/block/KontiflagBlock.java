...
public class KontiflagBlock extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:kontiflag")
	public static final Block block = null;

	public KontiflagBlock(LoloitemsModElements instance) {
		super(instance, 161);
	}
