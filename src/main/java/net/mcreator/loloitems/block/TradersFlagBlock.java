...
public class TradersFlagBlock extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:traders_flag")
	public static final Block block = null;

	public TradersFlagBlock(LoloitemsModElements instance) {
		super(instance, 163);
	}
