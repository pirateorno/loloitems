...
public class MagicFlagBlock extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:magic_flag")
	public static final Block block = null;

	public MagicFlagBlock(LoloitemsModElements instance) {
		super(instance, 164);
	}
