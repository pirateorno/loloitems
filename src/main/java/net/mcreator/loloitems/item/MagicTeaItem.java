...
public class MagicTeaItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:magic_tea")
	public static final Item block = null;

	public MagicTeaItem(LoloitemsModElements instance) {
		super(instance, 158);
	}
