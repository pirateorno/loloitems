...
public class PropuskkillersItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:propuskkillers")
	public static final Item block = null;

	public PropuskkillersItem(LoloitemsModElements instance) {
		super(instance, 151);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("propuskkillers");
		}
