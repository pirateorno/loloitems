...
public class FragmentskintaItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:fragmentskinta")
	public static final Item block = null;

	public FragmentskintaItem(LoloitemsModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fragmentskinta");
		}
