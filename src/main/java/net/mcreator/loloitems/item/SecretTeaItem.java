...
public class SecretTeaItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:secret_tea")
	public static final Item block = null;

	public SecretTeaItem(LoloitemsModElements instance) {
		super(instance, 159);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"\u041D\u0438\u043A\u043E\u043C\u0443 \u043D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u043E \u0438\u0437 \u0447\u0435\u0433\u043E \u0441\u0434\u0435\u043B\u0430\u043D \u044D\u0442\u043E\u0442 \u0431\u043E\u0436\u0435\u0441\u0442\u0432\u0435\u043D\u043D\u044B\u0439 \u0447\u0430\u0439"));
		}
