...
public class OskolocskintaItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:oskolocskinta")
	public static final Item block = null;

	public OskolocskintaItem(LoloitemsModElements instance) {
		super(instance, 3);
	}
