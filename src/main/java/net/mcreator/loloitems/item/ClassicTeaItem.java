...
public class ClassicTeaItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:classic_tea")
	public static final Item block = null;

	public ClassicTeaItem(LoloitemsModElements instance) {
		super(instance, 128);
	}
