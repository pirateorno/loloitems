...
public class PropuskrobbersItem extends LoloitemsModElements.ModElement {
	@ObjectHolder("loloitems:propuskrobbers")
	public static final Item block = null;

	public PropuskrobbersItem(LoloitemsModElements instance) {
		super(instance, 152);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("propuskrobbers");
		}
